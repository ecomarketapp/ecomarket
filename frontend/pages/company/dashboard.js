                    ...
                    <div className='px-2 py-6   '>
                        ...
                        <div className="flex items-center justify-center text-center mb-6 w-full">
                            ...
                            <div className="grow w-full">
                                ...
                                <p className='text-sm text-[#878A90] font-normal'>This is to enable EcoMarket deduct the exact amount you're being charged</p>
                        ...
                        <div className="flex items-center justify-center flex-col gap-2 text-center my-6 py-4 w-full">
                                ...
                                <p className='text-sm text-gray-700'>You're about to approve this amount to EcoMarket escrow wallet</p>
