...
//     try{
//       const res = await fetch(`${process.env.NEXT_PUBLIC_BACKEND_BASE_URL}/requests`)
//       if(res){
//         console.log(res);
              ...
              <div className="text-center">
                ...
                <div className="mb-10 mt-5">
                  <p className="text-md text-white">
                    Every piece of plastic sold on EcoMarket Marketplace is
                    fully certified, comes with documentation of its provenance
                    and information about its social and environmental impact.
                  </p>
                </div>
