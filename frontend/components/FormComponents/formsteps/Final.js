                    ...
                    <div className='flex items-center justify-center flex-col gap-4 mt-4 mx-auto w-full'>
                        ...
                        {moneyClaimed ? 
                            ...
                            <>
                                ...
                                <small className='text-xs font-thin mt-2 text-[#6D747D]'>EcoMarket would collect <span className='text-gray-700 font-bold'>2.5% </span></small>
            ...
            <div  className={`modal__box ${confirmTransfer ? 'show' : ''}`}>
                ...
                <div className=" mb-6">
                    ...
                    <div>
                        ...
                        <small className='text-xs font-thin  text-[#6D747D]'>EcoMarket would collect <span className='text-gray-700 font-bold'>2.5% </span></small>
