        ...
        <nav className="flex items-center flex-col px-4 py-4 h-full">
          ...
          <div className="w-full h-full">
            <div className="navbar-menu flex items-center justify-center flex-col gap-6 h-full ">
              ...
              <button onClick={router.asPath === '/' ? (handleHowItWorks) : redirectHowItWorks} className="block lg:inline-block lg:mt-0 text-blue-900 hover:text-indigo-600 px-5 text-2xl">
