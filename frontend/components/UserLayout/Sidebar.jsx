            ...
            {connected && (
              <div className="navbar-menu flex items-start justify-start flex-col gap-2 h-full ">
                <Link href="/collector/dashboard">
                  <a
                    className={`block mt-4 lg:inline-block lg:mt-0 text-[#5B5B5B]  hover:bg-[#FEF0E6] px-3 py-3 w-full rounded-md transition-all duration-200 ease-in-out ${
                ...
                <Link href="/collector/deliveries">
                  <a
                    className={`block lg:inline-block text-[#5B5B5B]  hover:bg-[#FEF0E6] px-3 py-3 w-full rounded-md transition-all duration-200 ease-in-out ${
