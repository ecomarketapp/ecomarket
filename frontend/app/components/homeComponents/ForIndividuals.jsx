        ...
        <div className="py-5 container mx-auto px-6 md:px-12">
          ...
          <div>
            <div className="flex flex-col items-center lg:flex-row-reverse lg:justify-between gap-12 lg:gap-20 mb-14 text-white">
                ...
                <div>
                  <AnimatePresence mode="wait">
                    <motion.div
                      ...
                      animate="visible"
                      exit="exit"
                      className="w-full flex flex-col h-auto bg-black bg-opacity-10 border border-blue-faded rounded-lg text-center px-1 py-1 shadow-lg"
                    >
                      <Image
              ...
              <div className="flex flex-col gap-5 lg:gap-6 w-full lg:w-[60%] border-l-2 border-[#DBDDDC]">
                {individualSlidesData.map((_, idx) => (
                  <div
                    key={idx}
                    onClick={() => handleDotClick(idx)}
