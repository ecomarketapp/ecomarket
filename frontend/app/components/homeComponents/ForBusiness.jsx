    ...
    <section className="bg-[#02351D] py-20 features__section relative">
      <div className="w-full">
        <div className="py-5 container mx-auto px-6 md:px-12">
          <div className="mb-16 text-center max-w-2xl mx-auto text-white">
            <h1 className="text-center text-[26px] md:text-4xl font-bold mb-[22px]">
              For Business
            </h1>
            <h3 className="text-sm md:text-xl font-normal text-center">
          ...
          <div>
            <div className="flex flex-col items-start lg:flex-row-reverse lg:justify-between gap-12 lg:gap-20 text-white">
              <div className="flex justify-center items-start lg:items-start w-full lg:w-1/2 lg:h-[504px] overflow-hidden">
                  ...
                  <div>
                    <AnimatePresence mode="wait">
                      <motion.div
                        ...
                        className="w-full flex flex-col h-auto  rounded-lg text-center px-1 py-1 shadow-lg"
                      >
                        {/* bg-[#02351D] bg-opacity-10 border border-[#898989] */}
                        <Image
              ...
              <div className=" w-full lg:w-[60%] flex flex-col justify-between h-full gap-6 ">
                <div className="flex flex-col gap-5 lg:gap-6 border-l-2 border-[#898989]">
                  {businessSlidesData.map((_, idx) => (
                    <div
                      key={idx}
                      onClick={() => handleDotClick(idx)}
